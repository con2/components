...
interface ReorderableDataTableMessages {
  dragToReorder: string;
}

interface ReorderableDataTableProps<Row> {
  className?: string;
  rows: Row[];
  columns: Column<Row>[];
  ...
  keyColumn: keyof Row;
  messages: ReorderableDataTableMessages;
}
...
export function ReorderableDataTable<Row>(
  props: ReorderableDataTableProps<Row>,
) {
